                    ...
                    <div class="col-xs-12">       
                        <div class="panel panel-default">                             
                            ...
                            <div class="panel-body cuerpo_del_panel">              
                                <div class="row">  
                                    <div class="col-sm-12">
                                        <asp:GridView ID="GridView_Supervisor" Width="100%" GridLines="Both" Font-Bold="false"  CssClass="gridview" BorderColor="#DEDFDE" BorderWidth="1px" BorderStyle="None"  runat="server" CellPadding="4" ForeColor="#333333" OnSelectedIndexChanged="Identificador_Supervisor" DataKeyNames="ID_Comentario" AutoGenerateColumns="false" >
                        ...
                        <div class="panel panel-warning">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-7">
                                            <asp:TextBox ID="Comentarios_Supervisor" TextMode="MultiLine" runat="server" Width="100%"  MaxLength="10"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-xs-5 control-label formulario">Fecha:</label>
                                        <div class="col-xs-7">
                                            <asp:TextBox ID="Fecha_Supervisor" Width="100%"  runat="server"></asp:TextBox>
                                        </div>
                                    </div>                                                
                                </form>
                            </div>
                            <div class="panel-footer pie_formulario">
                               <div class="col-xs-12"> 
                                            ...
                                            <asp:Button ID="Boton_Borrar_Supervisor" OnClientClick="return Confirmacion();" Width="100%"  CssClass="btn btn-danger btn_formulario" runat="server" Text="Borrar" OnClick="Boton_Borrar_Supervisor_Click" />
