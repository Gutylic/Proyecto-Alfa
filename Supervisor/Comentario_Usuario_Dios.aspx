                ...
                <div class="row">
                    <div class="col-xs-12">       
                        <div class="panel panel-default">                             
                            <div class="encabezado_panel panel-heading fondo" style="text-align:center"><h2 class="datos_del_administrador">Comentarios De Usuarios</h2></div>                      
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-11">
                                            <asp:TextBox ID="Usuario_Dios" Width="100%" Height="36px"  runat="server"></asp:TextBox>      
                                        </div>
                                    </div>                                    
                                    <div class="form-group">
                                        <label class="col-sm-1 control-label formulario">Comentario</label>
                                        <div class="col-sm-11">
                                            <asp:TextBox ID="Comentarios_Dios" TextMode="MultiLine" runat="server" Width="100%" Height="36px" ></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-1 control-label formulario">Correo</label>
                                        <div class="col-sm-11">
                                            <asp:TextBox ID="Correo_Dios" runat="server" Width="100%" Height="36px"></asp:TextBox>
                                        </div>
                                    </div>                                                                                
                                </form>
                            </div>
