...
{
    public partial class Pedido_Explicacion_Administrador : System.Web.UI.Page
    {
        Logica_Bloque_Pedido_Explicacion_Administrador LBPEA = new Logica_Bloque_Pedido_Explicacion_Administrador();
        ...
        public void Condiciones_Paginacion_Administrador() // pregunta en que momento tomo las condiciones del paginado si cuando arranca la pagina o cuando presiono el boton de buscar
        {
            ...
            ViewState["Cantidad_De_Datos"] = LBPEA.Logica_Contar_Cantidad_Explicaciones((string)Session["Empresa"]); // cuenta la cantidad de datos
        ...
        {
            GridView_Administrador.DataSource = LBPEA.Logica_Mostrar_Explicacion((string)Session["Empresa"]).Skip(Pagina * 20).Take(20);
        ...
        protected void Identificador_Administrador(object sender, EventArgs e) // convierto al datalist en editable 
        {
            ...
            Session["ID_Consulta"] = GridView_Administrador.DataKeys[row.RowIndex].Value; // captura el identificador del Administrador seleccionado
        ...
        protected void Boton_Resuelto_Administrador_Click(object sender, EventArgs e)
        {
            ...
            int Valor = LBPEA.Logica_Actualizar_Explicacion(TextBox_Administrador_Administrador.Text, true, (int)Session["ID_Consulta"]);
        ...
        protected void Boton_No_Resolver_Administrador_Click(object sender, EventArgs e)
        {
           ...
           int Valor = LBPEA.Logica_Actualizar_Explicacion(string.Empty, CheckBox_Realizado_Administrador.Checked, (int)Session["ID_Consulta"]);
        ...
        {
            int Valor = LBPEA.Logica_Actualizar_Explicacion((string)Session["Administrador"], false, (int)Session["ID_Consulta"]);
            if (Valor == 1) // todo ok
            {
