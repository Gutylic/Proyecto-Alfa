                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">                                            
                                            ...
                                            <div class="col-sm-8">
                                                <asp:Label ID="Valor_Ejercicio_Administrador" Width="100%" Height="36px"  runat="server"></asp:Label>                                                         
                                            </div>
                                        </div>                                    
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label formulario">Compra de Explicación en $:</label>
                                            <div class="col-sm-8">
                                                <asp:Label ID="Valor_Explicacion_Administrador" runat="server" Width="100%" Height="36px"></asp:Label>                                                        
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label formulario">Compra de Vídeo en $:</label>
                                            <div class="col-sm-8">
                                                <asp:Label ID="Valor_Video_Administrador" Width="100%" Height="36px" runat="server"></asp:Label>                                                       
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label formulario">Compra de Conjunto de Vídeos en $:</label>
                                            <div class="col-sm-8">
                                                <asp:Label ID="Valor_Conjunto_De_Videos_Administrador" runat="server" Width="100%" Height="36px"></asp:Label> 
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label formulario">Compra de Ejercicio Personalizado en $:</label>
                                            <div class="col-sm-8">
                                                <asp:Label ID="Valor_Ejercicio_Personalizado_Administrador" runat="server" Width="100%" Height="36px"></asp:Label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <asp:Label ID="Valor_Explicacion_Personalizada_Administrador" Width="100%" Height="36px" runat="server"></asp:Label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <asp:Label ID="Valor_Video_Personalizado_Administrador" runat="server" Width="100%" Height="36px"></asp:Label>                                            
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <asp:Label ID="Valor_Impresion_Administrador" runat="server" Width="100%" Height="36px"></asp:Label>                                            
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <asp:Label ID="Valor_Prestamo_SOS_Administrador" runat="server" Width="100%" Height="36px" ></asp:Label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <asp:Label ID="Duracion_De_Los_Ejercicios_Y_Las_Explicaciones_Administrador" Width="100%" Height="36px" runat="server"></asp:Label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <asp:Label ID="Duracion_De_Los_Videos_Administrador" runat="server" Width="100%" Height="36px"></asp:Label>                                            
