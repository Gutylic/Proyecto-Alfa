<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="Comentario_Administrador_Dios.aspx.cs" Inherits="Supervisor.Comentario_Administrador_Dios" %>
...
<head runat="server">
    ...
    <link href="css/comentario_administrador_Dios.css" rel="stylesheet"/>
                ...
                <div class="row">
                    <div class="col-xs-12">       
                        <div class="panel panel-default">                             
                            <div class="encabezado_panel panel-heading fondo" style="text-align:center"><h2 class="datos_del_administrador" style="margin-top: 0px;">Comentarios</h2></div>                               
                            <div class="panel-body cuerpo_del_panel">                
                                <div class="row">  
                                    <div class="col-sm-12">
                                        <asp:GridView ID="GridView_Dios" Width="100%" GridLines="Both" Font-Bold="false"  CssClass="gridview" BorderColor="#DEDFDE" BorderWidth="1px" BorderStyle="None"  runat="server" CellPadding="4" ForeColor="#333333" OnSelectedIndexChanged="Identificador_Dios" DataKeyNames="ID_Comentario" AutoGenerateColumns="false" >
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center" DataField="Fecha_Comentario_Realizado" HeaderText="Fecha" />  
                                            </Columns>
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-7">
                                                <asp:TextBox ID="Comentarios_Dios" TextMode="MultiLine" runat="server" Width="100%" MaxLength="10"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-xs-5 control-label formulario">Fecha:</label>
                                            <div class="col-xs-7">
                                                <asp:TextBox ID="Fecha_Dios" Width="100%" runat="server"></asp:TextBox>
                                            </div>
                                        </div>                                                
                                    </form>
                                </div>
