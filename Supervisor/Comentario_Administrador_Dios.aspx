                    ...
                    <div class="col-xs-12">       
                        <div class="panel panel-default">                             
                            ...
                            <div class="panel-body">                
                                <div class="row">  
                                    <div class="col-sm-12">
                                        <asp:GridView ID="GridView_Dios" Width="100%" GridLines="None" runat="server" OnSelectedIndexChanged="Identificador_Dios" DataKeyNames="ID_Comentario" AutoGenerateColumns="false" >
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Fecha_Comentario_Realizado" HeaderText="Comentario" />  
                                            </Columns>
                                        </asp:GridView>
                                    </div>                                        
                                </div>
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-11">
                                            <asp:TextBox ID="Comentarios_Dios" TextMode="MultiLine" runat="server" Width="100%" Height="36px" MaxLength="10"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-1 control-label formulario">Fecha:</label>
                                        <div class="col-sm-11">
                                            <asp:TextBox ID="Fecha_Dios" Width="100%" Height="36px" runat="server"></asp:TextBox>
                                        </div>
                                    </div>                                                
                                </form>
                            </div>
