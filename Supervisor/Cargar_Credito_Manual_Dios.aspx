<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cargar_Credito_Manual_Dios.aspx.cs" Inherits="Supervisor.Cargar_Credito_Manual_Dios" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    <link href="css/cargar_de_credito_manual_dios.css" rel="stylesheet" />    
            ...
            <div class="row">
                <div class="col-xs-12">       
                    <div class="panel panel-default">                             
                        <div class="encabezado_panel panel-heading fondo" style="text-align:center"><h2 class="datos_del_administrador">Carga Manual</h2></div>                 
