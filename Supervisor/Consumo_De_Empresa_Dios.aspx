                ...
                <div class="row">
                    <div class="col-xs-12">       
                        <div class="panel panel-default">                             
                            <div class="encabezado_panel panel-heading fondo"><h2 class="datos_del_administrador">Consumo Interno</h2>
                            <hr />
                                <div class="row">
                                    <div class="col-xs-3">
                            ...
                            <div class="panel-body">                                                                              
                                <div class="row">  
                                    <div class="col-sm-12">
                                        <asp:GridView ID="GridView_Dios" Width="100%" GridLines="None" runat="server" OnSelectedIndexChanged="Identificador_Dios" DataKeyNames="ID_Consulta" AutoGenerateColumns="false" >
                                            <Columns>
                                                <asp:TemplateField HeaderText="Administrador de la Empresa">
                                                    <ItemTemplate>
                                                ...
                                                <asp:BoundField DataField="Fecha_De_Consulta" HeaderText="Fecha del Movimiento" />
                                                <asp:BoundField DataField="Tipo_De_Consulta" HeaderText="Movimiento" />                  
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal">
                                    <div class="form-group">
                                        <label class="col-sm-5 control-label formulario">Administrador</label>
                                        <div class="col-sm-7">
                                            <asp:Label ID="Administrador_Dios" Width="100%" Height="36px"  runat="server"></asp:Label>      
                                        </div>
                                    </div>                                    
                                    <div class="form-group">
                                        <label class="col-sm-5 control-label formulario">Fecha del Movimiento</label>
                                        <div class="col-sm-7">
                                            <asp:Label ID="Fecha_Dios" runat="server" Width="100%" Height="36px" ></asp:Label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-5 control-label formulario">Tipo de Consulta</label>
                                        <div class="col-sm-7">
                                            <asp:Label ID="Descripcion_Dios" runat="server" Width="100%" Height="36px"></asp:Label>
                                        </div>
                                    </div>  
                                    <div class="form-group">
                                        <label class="col-sm-5 control-label formulario">Empresa</label>
                                        <div class="col-sm-7">
