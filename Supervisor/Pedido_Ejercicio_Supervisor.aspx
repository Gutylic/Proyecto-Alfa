                    ...
                    <div class="col-xs-12">       
                        <div class="panel panel-default">                             
                            ...
                            <div class="panel-body"> 
                                <div class="row">  
                                    <div class="col-sm-12">
                                        <asp:GridView ID="GridView_Supervisor" Width="100%" GridLines="None" runat="server" AutoGenerateColumns="false" OnSelectedIndexChanged="Identificador_Supervisor" DataKeyNames="ID_Pedido" >
                                            <Columns>
                        ...
                        <div class="panel panel-warning">
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <div class="col-sm-8" style="margin-bottom:5px">
                                            <asp:Button ID="Boton_Archivo_Adjunto_Supervisor" runat="server" Text="Descargar Adjunto" CssClass="btn btn-danger" Height="30px" OnClick="Boton_Archivo_Adjunto_Supervisor_Click" />   
                                        </div>
                                    </div>                                    
                                    <div class="form-group" >
                                        <label class="col-sm-4 control-label formulario">Ficha</label>
                                        <div class="col-sm-8" style="margin-bottom:5px">
                                            <asp:Button ID="Boton_Archivo_Ficha_Supervisor" runat="server" Text="Descargar Ficha" CssClass="btn btn-warning" Height="30px" OnClick="Boton_Archivo_Ficha_Supervisor_Click" />
                                        </div>
                                    </div>
                                    <div class="form-group" >
                                        <label class="col-sm-4 control-label formulario">Enunciado</label>
                                        <div class="col-sm-8" style="margin-bottom:5px">
                                            <asp:Button ID="Boton_Archivo_Enunciado_Supervisor" runat="server" Text="Descargar Enunciado" CssClass="btn btn-primary" Height="30px" OnClick="Boton_Archivo_Enunciado_Supervisor_Click" />
                                        </div>
                                    </div>                                                                                
                                    <div class="form-group" >
                            ...
                            <div class="panel-footer" style="height:55px">
                                ...
                                <div class="col-xs-3">
                                                <asp:Button ID="Boton_No_Resolver_Supervisor" OnClientClick="return Confirmacion();" CssClass="btn btn-warning" runat="server" Text="No Resolver" Width="100%" Height="36px" OnClick="Boton_No_Resolver_Supervisor_Click" />
                                            </div>
                                            <div class="col-xs-3">
                                                <asp:Button ID="Boton_Resolver_El_Ejercicio_Supervisor" OnClientClick="return Confirmacion();" CssClass="btn btn-primary" runat="server" Text="Resolviendo..." Width="100%" Height="36px" OnClick="Boton_Resolver_El_Ejercicio_Supervisor_Click" />
                                            </div>
                                            <div class="col-xs-3">
                                                <asp:Button ID="Boton_Resuelto_Supervisor" CssClass="btn btn-success" OnClientClick="return Confirmacion();" runat="server" Text="Resuelto" Width="100%" Height="36px" OnClick="Boton_Resuelto_Supervisor_Click" />
                                            </div>
                                            <div class="col-xs-3">
                                                <asp:Button ID="Boton_Borrar_Supervisor" runat="server" OnClientClick="return Confirmacion();" CssClass="btn btn-danger" Text="Borrar" Width="100%" Height="36px" OnClick="Boton_Borrar_Supervisor_Click" />
                                            </div>
                            </div>
                        </div>
                    </div>
