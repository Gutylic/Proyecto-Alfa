...
{
    public partial class Comentario_Administrador_Dios : System.Web.UI.Page
    {
        Logica_Bloque_Comentario_Administrador_Dios LBCAD = new Logica_Bloque_Comentario_Administrador_Dios();
        ...
        public void Condiciones_Paginacion_Dios() // pregunta en que momento tomo las condiciones del paginado si cuando arranca la pagina o cuando presiono el boton de buscar
        {
            ...
            ViewState["Cantidad_De_Datos"] = LBCAD.Logica_Contar_Comentarios(); // cuenta la cantidad de datos
        ...
        {
            GridView_Dios.DataSource = LBCAD.Logica_Comentario_Administradores().Skip(Pagina * 20).Take(20);
        ...
        protected void Identificador_Dios(object sender, EventArgs e) // convierto al datalist en editable 
        {
            ...
            Session["ID_Comentario"] = GridView_Dios.DataKeys[row.RowIndex].Value; // captura el identificador del Administrador seleccionado
            List<Seleccionar_Comentario_Administrador_DiosResult> Datos = LBCAD.Logica_Seleccionar_Comentario((int)Session["ID_Comentario"]); // carga los datos del administrador elegido por el Dios
            ...
            Fecha_Dios.Text = Datos[0].Fecha_Comentario_Realizado.ToString(); // carga la categoria de la base
        }
        ...
        {
            int Valor = LBCAD.Logica_Borrar_Comentario((int)Session["ID_Comentario"]); // Borrar el administrador
            if (Valor == 1) // todo ok
            {
