                        ...
                        <div class="panel panel-default">                             
                            ...
                            <div class="panel-body"> 
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label formulario">Bonificación por Cantidad en $:</label>
                                        <div class="col-sm-8">
                                                <asp:Label ID="Bonificacion_Por_Cantidad_Administrador" runat="server" Width="100%" Height="36px"></asp:Label>                                              
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label formulario">Descuento por la Compra de un Producto en %:</label>
                                        <div class="col-sm-8">
                                            <asp:Label ID="Descuento_En_La_Compra_Del_Producto_Administrador" runat="server" Width="100%" Height="36px"></asp:Label>                                                    
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label formulario">Bonificación en la Próxima Recarga:</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label formulario">Duración de la Compra (en días):</label>
                                        <div class="col-sm-8">
