<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cargar_Credito_Manual_Administrador.aspx.cs" Inherits="Supervisor.Cargar_Credito_Manual_Administrador" EnableEventValidation="false" UICulture="de" Culture="en-US"  %>
                    ...
                    <div class="col-md-12">                       
                        <div class="row">
                            ...
                            <div class="col-xs-4 consola_de_control" style="text-align:center">
                                <h1 class="titulo">Carga de Crédito</h1>
                            </div> 
            ...
            <div class="row">
                <div class="col-xs-12">       
                    <div class="panel panel-default">                             
                        <div class="encabezado_panel panel-heading fondo" style="text-align:center"><h2 class="datos_del_administrador">Carga Manual de Crédito</h2></div>                 
