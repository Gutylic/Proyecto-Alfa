<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Panel_De_Control_Administrador.aspx.cs" Inherits="Supervisor.Panel_De_Control_Administrador" EnableEventValidation="false" %>
            ...
            <div class="row">
                <div class="col-xs-12">       
                    <div class="panel panel-default">                             
                        <div class="encabezado_panel panel-heading fondo" style="text-align:center"><h2 class="datos_del_administrador">Ficha</h2></div>                 
                        ...
                        <div class="panel-footer">
                            <asp:UpdatePanel ID="UpdatePanel_Botonera" runat="server">
                                <ContentTemplate>
                                    <asp:Button ID="Boton_Actualizar_Administrador" OnClientClick="return Confirmacion();" Class="btn btn-warning" runat="server" Text="Actualizar" Width="100%" OnClick="Boton_Actualizar_Administrador_Click" />
                                </ContentTemplate>
                            </asp:UpdatePanel>                    
                        </div>
                    </div>
