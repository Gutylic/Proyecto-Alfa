                            ...
                            <div class="panel-body">
                                <form class="form-horizontal">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-11">
                                            <asp:TextBox ID="Usuario_Supervisor" Width="100%" Height="36px"  runat="server"></asp:TextBox>      
                                        </div>
                                    </div>                                    
                                    <div class="form-group">
                                        <label class="col-sm-1 control-label formulario">Comentario</label>
                                        <div class="col-sm-11">
                                            <asp:TextBox ID="Comentarios_Supervisor" TextMode="MultiLine" runat="server" Width="100%" Height="36px" ></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group">
