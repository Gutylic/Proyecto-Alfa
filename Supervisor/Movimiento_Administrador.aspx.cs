...
{
    public partial class Movimiento_Administrador : System.Web.UI.Page
    {

        Logica_Bloque_Movimiento_Administrador LBMA = new Logica_Bloque_Movimiento_Administrador();
        ...
        public void Condiciones_Paginacion_Administrador(string Usuario) // pregunta en que momento tomo las condiciones del paginado si cuando arranca la pagina o cuando presiono el boton de buscar
        {
            ...
            ViewState["Cantidad_De_Datos"] = LBMA.Logica_Contar_Movimientos(Usuario, (string)Session["Empresa"]); // cuenta la cantidad de datos
        ...
        public void Mostrar_Datos_Administrador(string Usuario, int Pagina)
        {
            ...
            GridView_Administrador.DataSource = LBMA.Logica_Mostrar_Movimientos(Usuario,(string)Session["Empresa"]).Skip(Pagina * 20).Take(20);
