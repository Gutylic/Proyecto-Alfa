                            ...
                            <div class="panel panel-default">                             
                                ...
                                <div class="panel-body">                
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <asp:Button ID="Boton_Ejercicio" Width="100%" CssClass="btn btn-danger" runat="server" Text="Respuesta del Ejercicio" OnClick="Boton_Ejercicio_Click" />
                                        </div>
                                    </div>  
                                </div>
                            </div>
                            <div class="panel panel-default">                             
                                ...
                                <div class="panel-body">                
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <asp:Button ID="Boton_Videos" Width="100%" CssClass="btn btn-warning" runat="server" Text="Obtener Vídeos" OnClick="Boton_Videos_Click" />
                                        </div>
                                    </div>  
                                </div>
                            </div>           
