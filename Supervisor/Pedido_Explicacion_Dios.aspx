                    ...
                    <div class="col-xs-12">       
                        <div class="panel panel-default">                             
                            ...
                            <div class="panel-body"> 
                                <div class="row">  
                                    <div class="col-sm-12">
                                        <asp:GridView ID="GridView_Dios" Width="100%" GridLines="None" runat="server" AutoGenerateColumns="false" OnSelectedIndexChanged="Identificador_Dios" DataKeyNames="ID_Consulta" >
                                            <Columns>
                    ...
                    <div class="col-xs-12" > 
                        <div class="panel panel-warning">
                                        ...
                                        <form class="form-horizontal">                                                                                                        
                                            <div class="form-group" >
                                                ...
                                                <div class="col-sm-8" style="margin-bottom:5px">
                                                   <asp:Label ID="Etiqueta_Numero_De_Ejercicio_Dios" runat="server"></asp:Label>
                                                </div>
                                            </div>      
                                            <div class="form-group" >
                            ...
                            <div class="panel-footer" style="height:55px">
                                ...
                                <div class="col-xs-12">
                                    <asp:Button ID="Boton_Borrar_Dios" CssClass="btn btn-danger" OnClientClick="return Confirmacion();" runat="server" Text="Borrar" Width="100%" Height="36px" OnClick="Boton_Borrar_Dios_Click" />
                                </div>
                            </div>
