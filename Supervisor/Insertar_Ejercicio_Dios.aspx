<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Insertar_Ejercicio_Dios.aspx.cs" Inherits="Supervisor.Insertar_Ejercicio_Dios" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    <link href="css/insertar_ejercicio_dios.css" rel="stylesheet"/>
...
<body>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        ...
        <div class="navbar navbar-default" id="subnav">
            ...
            <div class="container">         
               <div class="well boton_formulario">
                    <div class="col-xs-12 ">
                        <asp:Button ID="Boton_Insertar_Dios" Width="100%" CssClass="btn btn-success " runat="server" Text="Insertar" OnClientClick="return Confirmacion();" OnClick="Boton_Insertar_Dios_Click" />
                    </div>
                </div>
            </div>           
            <hr />
