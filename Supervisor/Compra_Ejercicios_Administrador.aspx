<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" UICulture="de" Culture="en-US" CodeBehind="Compra_Ejercicios_Administrador.aspx.cs" Inherits="Supervisor.Compra_Ejercicios_Administrador" %>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel_Botonera" runat="server">   
                            <ContentTemplate>         
                                <div class="panel panel-default">                             
                                    <div class="encabezado_panel panel-heading fondo" style="height:150px; text-align:center"><h2 class="datos_del_administrador">Resoluciones de Ejercicios</h2>                                      
                                        <hr />
                                        <div class="col-xs-6">
