                ...
                <div class="row">
                    <div class="col-xs-12">       
                        <div class="panel panel-default">                             
                            <div class="encabezado_panel panel-heading fondo" style="text-align:center"><h2 class="datos_del_administrador">Personalizado</h2></div>              
                            <div class="panel-body cuerpo_del_panel"> 
                                <div class="row">  
                                    <div class="col-sm-12">
                                        <asp:GridView ID="GridView_Administrador" Width="100%" GridLines="Both" Font-Bold="false"  CssClass="gridview" BorderColor="#DEDFDE" BorderWidth="1px" BorderStyle="None" runat="server" CellPadding="4" ForeColor="#333333" AutoGenerateColumns="false" OnSelectedIndexChanged="Identificador_Administrador" DataKeyNames="ID_Pedido" >
                        ...
                        <div class="panel-body">
                                <form class="form-horizontal">
                                    <div class="form-group" >
                                        ...
                                        <div class="col-sm-8">
                                            <asp:Button ID="Boton_Archivo_Adjunto_Administrador" runat="server" Text="Bajar Adjunto" CssClass="btn btn-danger btn_pedido" Width="100%" OnClick="Boton_Archivo_Adjunto_Administrador_Click" />   
                                        </div>
                                    </div>                                    
                                    <div class="form-group" >
                                        <label class="col-sm-4 control-label formulario">Ficha</label>
                                        <div class="col-sm-8">
                                            <asp:Button ID="Boton_Archivo_Ficha_Administrador" runat="server" Text="Bajar Ficha" CssClass="btn btn-warning btn_pedido" Width="100%" OnClick="Boton_Archivo_Ficha_Administrador_Click" />
                                        </div>
                                    </div>
                                    <div class="form-group" >
                                    ...
                                    <div class="form-group" >
                                        <label class="col-sm-4 control-label formulario">Ejercicio:</label>
                                        <div class="col-sm-8" style="margin-bottom:9px">
                                           <asp:CheckBox ID="CheckBox_Ejercicio_Administrador" runat="server" Enabled="false" />
                                        </div>
                                    </div>  
                                    <div class="form-group" >
                                        <label class="col-sm-4 control-label formulario">Explicación:</label>
                                        <div class="col-sm-8" style="margin-bottom:9px">
                                           <asp:CheckBox ID="CheckBox_Explicacion_Administrador" runat="server" Enabled="false" />
                                        </div>
                                    </div>       
                                    <div class="form-group" >
                                        <label class="col-sm-4 control-label formulario">Pedido</label>
                                        <div class="col-sm-8" style="margin-bottom:9px">
                                           <asp:Label ID="Etiqueta_Fecha_Administrador" runat="server"></asp:Label>
                                        </div>
                                    </div>  
                                    <div class="form-group" >
                                        <label class="col-sm-4 control-label formulario">Profesor:</label>
                                        <div class="col-sm-8" style="margin-bottom:9px">
                                            <asp:TextBox ID="TextBox_Administrador_Administrador" Width="100%" runat="server"></asp:TextBox>
                                        </div>
                                    </div>   
                                    <div class="form-group" >
                                        <label class="col-sm-4 control-label formulario">Realizado:</label>
                                        <div class="col-sm-8">
                             ...
                             <div class="panel-footer" style="height:55px">
                                <div class="col-xs-4">
                                    <asp:Button ID="Boton_No_Resolver_Administrador" runat="server" Text="No" CssClass="btn btn-warning btn_formulario" Width="100%"  OnClick="Boton_No_Resolver_Administrador_Click" />
                                </div>
                                <div class="col-xs-4">
                                    <asp:Button ID="Boton_Resolver_El_Ejercicio_Administrador" runat="server" CssClass="btn btn-primary btn_formulario"  Width="100%" Text="Resol..." OnClick="Boton_Resolver_El_Ejercicio_Administrador_Click" />
                                </div>
                                <div class="col-xs-4">
                                    <asp:Button ID="Boton_Resuelto_Administrador" runat="server" Text="Ok" CssClass="btn btn-success btn_formulario" Width="100%"  OnClick="Boton_Resuelto_Administrador_Click" />
                                </div>
                            </div>
                        </div>
                  </div>
