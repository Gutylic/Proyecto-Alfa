...
{
    public partial class Compra_Ejercicios_Administrador : System.Web.UI.Page
    {
        Logica_Bloque_Comprar_Ejercicios_Administrador LBCEA = new Logica_Bloque_Comprar_Ejercicios_Administrador();     
        ...
        public void Condiciones_Paginacion_Administrador(string Usuario) // pregunta en que momento tomo las condiciones del paginado si cuando arranca la pagina o cuando presiono el boton de buscar
        {
            ...
            ViewState["Cantidad_De_Datos"] = LBCEA.Logica_Contar_Ejercicios(Usuario); // cuenta la cantidad de datos
        ...
        public void Mostrar_Datos_Administrador(string Usuario, int Pagina)
        {
            ...
            GridView_Administrador.DataSource = LBCEA.Logica_Mostrar_Ejercicios(Usuario).Skip(Pagina * 20).Take(20);
